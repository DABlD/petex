	...
	<div class="row">
		<section class="col-lg-12">
			<div class="box box-info">
				...
				<div class="box-body">
					<form method="POST" action="{{ route('users.store') }}" id="createForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control aeigh" name="address" placeholder="Enter Address" readonly>
                                <span class="invalid-feedback hidden" role="alert">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <br>
                                <select name="role" id="role" class="form-control aeigh">
                                	<option></option>
                        ...
                        <div class="row">
                            <div class="form-group col-md-7" style="padding-left: 15px;">
                                ...
                                <label for="files" style="color: red;">
                                ...
                                <input type="file" class="aeigh" name="files[]" placeholder="Upload Files" multiple accept="image/*"><br>
                                <span class="invalid-feedback hidden" role="alert">
    ...
    <script>
        ...
        $('.submit').click(() => {
            ...
            $.each(inputs, (index, input) => {
                ...
                let error = $('#' + temp.attr('name').replace(/\[\]/g, '') + 'Error');//modified for files[]
                bool = false;
